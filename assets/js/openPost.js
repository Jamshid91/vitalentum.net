...
const replys = document.querySelectorAll('.reply'),
      postCommClose = document.querySelectorAll('.post-comment__close')


replys.forEach(reply => {
    reply.addEventListener('click', () => {
       let addComm = reply.parentElement.parentElement.parentElement.nextElementSibling;

       addComm.classList.remove('d-none');
       addComm.classList.add('d-flex');
    })
})

postCommClose.forEach(close => {
    close.addEventListener('click', () => {
       let addComm = close.parentElement.parentElement.parentElement;

       addComm.classList.add('d-none');
       addComm.classList.remove('d-flex');
    })
})